...

{
    ...
    public class TimeSystem : MonoBehaviour
    {
        ...
        private void CreateSimpleTimeData()
        {
            ...
            NeedModifiers.Add("Tiredness", tirednessEvaluationModifiers);
            NeedModifiers.Add("Hunger", hungerEvaluationModifiers);
            NeedModifiers.Add("Diligence", workEvaluationModifiers);
        }
        ...
        private void updateWeights()
        {
            ...
            foreach (string needName in Simulation.Manager.Instance.Data.NeedNames)
            {
